...
class Edit extends \Zigly\Plan\Controller\Adminhtml\Plan
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('zigly_plan_plan', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit %1', $model->getPlanName()) : __('New Plan'));
        return $resultPage;
    }

    protected function _isAllowed()
    {
        return $this->_authorization->isAllowed('Zigly_Plan::Plan_update');
    }
}
