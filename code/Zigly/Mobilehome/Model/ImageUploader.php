...
class ImageUploader
{
    const IMAGE_TMP_PATH = 'Zigly/tmp/mobilehome';
 
    const IMAGE_PATH = 'Zigly/mobilehome';
    /**
    ...
    public function moveFileFromTmp($imageName)
    {
        ...
        try {
            $this->coreFileStorageDatabase->copyFile($baseTmpImagePath,
                $baseImagePath
            );
            ...
            throw new LocalizedException(
                __('Something went wrong while saving the file(s).'.$e)
            );
        }
