...
namespace Zigly\VetConsulting\Controller\Video;
    ...
    public function execute()
    {
        ...
        try {
            if (!empty($consultSession)) {
                ...
                $sku = $this->scopeConfig->getValue('vetconsulting/product_config/sku_for_video', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
