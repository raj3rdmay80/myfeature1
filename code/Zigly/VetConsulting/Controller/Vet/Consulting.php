...
class Consulting extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $breadcrumbs->addCrumb('in-clinic',
            [
                'label' => __('In-Clinic Appointments'),
                'title' => __('In-Clinic Appointments')
            ]
        );
        return $resultPage;
    }
