...
class ImageCustomerAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'customerprofile_image', [
            'type' => 'text',
            'label' => 'Profile Image',
            'input' => 'file',
            'source' => '',
        ...
        $newAttribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'customerprofile_image');
