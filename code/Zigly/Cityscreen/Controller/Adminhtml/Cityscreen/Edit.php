...
class Edit extends \Zigly\Cityscreen\Controller\Adminhtml\Cityscreen
{
    ...
    {
        return $this->_authorization->isAllowed('Zigly_Cityscreen::Cityscreen_update');
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('zigly_cityscreen_cityscreen', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit City %1', $model->getCity()) : __('New City'));
        return $resultPage;
    }
}
