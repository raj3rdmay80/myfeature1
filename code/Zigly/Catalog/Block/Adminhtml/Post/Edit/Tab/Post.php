...
namespace Zigly\Catalog\Block\Adminhtml\Post\Edit\Tab;
...
class Post extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        $this->date = $dateTime;
        $this->layoutOptions = $layoutOption;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('author_id', 'select', [
            ...
            'title' => __('Author'),
            'required' => true,
            'values' => $this->author->toOptionArray()
        ]);
        ...
        $fieldset->addField('image', \Zigly\Catalog\Block\Adminhtml\Renderer\Image::class, [
            'name' => 'image',
            'label' => __('Image'),
            'title' => __('Image'),
            'required' => true,
        ...
        <script>
            require([
                ...
                $(document).ready(function () {
                    var image="'.$post->getData('image').'";
                    if($("#post_image").attr("value") == image){
                        $("#post_image").removeClass("required-file");
                    }
                    if(image == ""){
                        $("#post_image").removeAttr("value");
    ...
    ');
        ...
        $fieldset->addField('show_in_zigly', 'select', [
            'name' => 'show_in_zigly',
            'label' => __('Show In Zigly'),
            'title' => __('Show In Zigly'),
            'values' => [
                0 => ' ',
                1 => 'Homepage',
                2 => 'At Home',
        ...
        $designFieldset->addField('layout', 'select', [
            ...
            'label' => __('Layout'),
            'title' => __('Layout'),
            'values' => $this->layoutOptions->toOptionArray()
        ]);
