...
class Experience extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * Experience product collection
     * @return ProductFactory
     */
    public function getExperienceProductCollection()
    {
        $limit = '56';
        $collection = $this->productCollectionFactory->create();
        $collection->addAttributeToSelect('*');
        /*$collection->addCategoriesFilter(['in' => [28]]);*/
        $collection->addAttributeToFilter('show_at_experience',  array('eq' => '1'));
    ...
    public function getBlog()
    {
        $blogs = $this->blogPostCollection->create()->join(
            ...
            'category.post_id = main_table.post_id and category.category_id = 6',
