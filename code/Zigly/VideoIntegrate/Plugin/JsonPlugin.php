...
namespace Zigly\VideoIntegrate\Plugin;
...
class JsonPlugin
{
    ...
    {
        if (($this->request->getPathInfo() == "/V1/videointegration/getvettoken" || $this->request->getPathInfo() == "/V1/orders/cancel" )&& $this->isJson($data)) {
            return $data;
        }
        return $proceed($data);
    }
