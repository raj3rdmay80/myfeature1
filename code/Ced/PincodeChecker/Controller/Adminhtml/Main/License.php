...
namespace Ced\PincodeChecker\Controller\Adminhtml\Main;

use Magento\Backend\App\Action\Context;

/**
 * Class License
 * @package Ced\PincodeChecker\Controller\Adminhtml\Main
 */
            ...
            if ($response && isset($response['hash']) && isset($response['level'])) {
                ...
                try {
                    ...
                    if (is_array($valid) &&
                        ...
                        $path = \Ced\PincodeChecker\Block\Extensions::HASH_PATH_PREFIX . strtolower($postData['module_name']) . '_hash';
                        $this->_feedHelper->setDefaultStoreConfig($path, $response['hash'], 0);
                        $path = \Ced\PincodeChecker\Block\Extensions::HASH_PATH_PREFIX . strtolower($postData['module_name']) . '_level';
