...
class Feed extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    )
    {
        ...
        $this->_allowedFeedType = explode(',', $backendConfig->getValue(\Ced\PincodeChecker\Model\Feed::XML_FEED_TYPES));
    ...
    public function getEnvironmentInformation()
    {
        ...
        $info['domain_name'] = $this->_urlBuilder->getBaseUrl();
        ...
        $info['feed_types'] = $this->_backendConfig->getValue(\Ced\PincodeChecker\Model\Feed::XML_FEED_TYPES);
