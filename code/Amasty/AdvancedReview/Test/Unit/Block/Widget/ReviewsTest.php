...
class ReviewsTest extends \PHPUnit\Framework\TestCase
{
    ...
    private function prepareDataForCreateCollection()
    {
        ...
        $reviewCollection = $this->createPartialMock(
            ...
            ['addStoreFilter', 'addStatusFilter', 'setPageSize', 'getSelect', 'setFlag', 'setOrder', 'setDateOrder']
        );
        ...
        $select->expects($this->any())->method('having')->willReturn($select);
        ...
        $reviewCollection->expects($this->any())->method('getSelect')->willReturn($select);
        ...
        $this->setProperty($block, 'reviewCollectionFactory', $reviewCollectionFactory, Reviews::class);
