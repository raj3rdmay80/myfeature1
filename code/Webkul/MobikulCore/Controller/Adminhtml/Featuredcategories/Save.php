    ...
    public function execute()
    {
        ...
        if ($originalRequestData) {
            try {
                ...
                if (isset($featuredcategoriesData["filename"][0]["url"])) {
                    $pos = strpos($featuredcategoriesData["filename"][0]["url"], "media") + 6;
                    $featuredcategoriesData["filename"] = substr($featuredcategoriesData["filename"][0]["url"], $pos);
                } elseif (strpos($imageName, "mobikul/featuredcategories/") !== false) {
