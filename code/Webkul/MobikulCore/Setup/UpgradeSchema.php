...
/**
 * Class Upgrade Schema to upgrade database
 */
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $setup->getConnection()
        ->newTable($setup->getTable("mobikul_walkthrough"))
        ->addColumn(
            "id",
            $integerType,
            null,
        ...
        ->addColumn("title", $textType, 50, ["nullable"=>true, "default"=>null], "Title")
        ->addColumn("description", $textType, 200, ["nullable"=>true, "default"=>null], "Title")
        ->addColumn("color_code", $textType, null, ["nullable"=>true, "default"=>null], "Color Code")
        ->addColumn("image", $textType, 255, ["nullable"=>true, "default"=>null], "Selected Image")
        ->addColumn("status", $integerType, null, ["unsigned"=>true, "nullable"=>false, "default"=>"0"], "Status")
        ->addColumn(
            "sort_order",
            $integerType,
        ...
        ->setComment("Mobikul Walk Through");
        $setup->getConnection()->createTable($table);
