    ...
    public function execute()
    {
        try {
            ...
            if ($this->customer->getId() && $this->orderId) {
                ...
                $order = $objectManager->create(\Magento\Sales\Model\Order::class)->load($this->orderId);
